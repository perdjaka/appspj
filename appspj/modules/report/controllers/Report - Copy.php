...
class Report extends MX_Controller{
	...
	function cetakSpj(){
		...
		$this->fpdf->MultiCell(0.5,0.5,':');
		$this->fpdf->setXY(10.3,8.4);
		$this->fpdf->MultiCell(2,0.5,'Nomor');
		$this->fpdf->setXY(11.9,8.4);
		$this->fpdf->MultiCell(0.5,0.5,':');
		$this->fpdf->setXY(12.2,8.4);
		$this->fpdf->MultiCell(8,0.5,$nomorNotaDinas);
		$this->fpdf->setXY(10.3,8.9);
		$this->fpdf->MultiCell(2,0.5,'Tanggal');
		$this->fpdf->setXY(11.9,8.9);
		$this->fpdf->MultiCell(0.5,0.5,':');
		$this->fpdf->setXY(12.2,8.9);
		$this->fpdf->MultiCell(8,0.5,day($tanggalNotaDinas));
		$this->fpdf->setXY(10.3,9.4);
		$this->fpdf->MultiCell(2,0.5,'Tentang');
		$this->fpdf->setXY(11.9,9.4);
		$this->fpdf->MultiCell(0.5,0.5,':');
		$this->fpdf->setXY(12.2,9.4);
		...
		$this->fpdf->Text(12,4.5,$JAB_PLT);	
		
		$this->fpdf->SetXY(12.5,6.5);
	...
	function cetakSpjMulti() {		
		...
		$koorY = $GetY + $rr;
		$this->fpdf->setFont('Arial','B',10);
		$this->fpdf->Text(12,$koorY,'KEPALA BALAI BESAR PENGUJIAN PERANGKAT TELEKOMUNIKASI');
		$GetY= $this->fpdf->GetY();
		$rr = 4.5;
		$koorY = $GetY + $rr;
	...
	*/
	...
	function cetakSppd() {
		...
		//Header
		$this->fpdf->setFont('Arial','B',12.5);
		$this->fpdf->Text(3,1.7,'KEMENTERIAN KOMUNIKASI DAN INFORMATIKA DIREKTORAT JENDERAL');
		$this->fpdf->Text(4.4,2.3,'SUMBER DAYA DAN PERANGKAT POS DAN INFORMATIKA');		
		...
		$this->fpdf->Text(6,3.7,'BEKASI BARAT 17134 ');
		$this->fpdf->Ln();
		...
		$this->fpdf->Text(6.9,5.7,'SURAT PERINTAH PERJALANAN DINAS');
		$this->fpdf->Text(6.9,5.7,'___________________________________');	
		...
		$this->fpdf->MultiCell(7.7,0.65,'KEPALA BALAI BESAR PENGUJIAN PERANGKAT TELEKOMUNIKASI, SESUAI SPT NO. '.$this->mr->getNoSptApprove(),'TRB');
		$this->fpdf->Ln();
